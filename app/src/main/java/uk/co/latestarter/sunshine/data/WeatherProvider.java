...
public class WeatherProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // Date is stored as String, hence /* and not numeric /#
    ...
    private Cursor getWeatherByLocationWithDateSetting(Uri uri, String[] projection, String sortOrder) {
        String locationSetting = WeatherContract.WeatherEntry.getLocationSettingFromUri(uri);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE: {
                retCursor = getWeatherByLocationWithDateSetting(uri, projection, sortOrder);
                break;
            }
            // "weather/*"
        ...
        // Cursor to register as a content observer to watch for changes to URI and its descendants
