...
import uk.co.latestarter.sunshine.MainActivity;
...
//        Log.v(LOG_TAG, "onPerformSync - SunshineSyncService");
    ...
    private void notifyWeather() {
        ...
        // checking the last update and notify if it is the first of the day
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            Uri weatherUri = WeatherEntry.buildWeatherLocationWithDate(locationQuery, new Date());
