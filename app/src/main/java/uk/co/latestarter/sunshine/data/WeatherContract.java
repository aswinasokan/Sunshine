...
public class WeatherContract {
    // Content authority
    public static final String CONTENT_AUTHORITY = "uk.co.latestarter.sunshine";

    // Base of all URIs
    public static final Uri BASE_CONTENT_URI = Uri.parse("content://" + CONTENT_AUTHORITY);

    // Paths to be appended to URI
     ...
     */
    public static Date getDateFromDbString(String dateText) {
